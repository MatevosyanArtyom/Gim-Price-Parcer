...
import { PropertyValueEditItemProps } from './types'

const n = nameofFactory<client.ProductPropertyValueEdit>()

const PropertyValueEditItem: React.FC<PropertyValueEditItemProps> = (props) => {
...
export default PropertyValueEditItem